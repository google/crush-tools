...
#ifndef CONVDATE_MAIN_H
#define CONVDATE_MAIN_H
...
#define APPLICATION_DESCRIPTION "converts a date within a field of a dt file into a different format."
...
struct cmdargs {
	...
	char *field;	/**< @brief 1-based number of field to convert (default: 1) */
	char *input_format;	/**< @brief date format in the input file - see strptime (required) */
	char *output_format;	/**< @brief date format in the output file - see strftime (required) */
	int preserve_header;	/**< @brief preserve the header line (default: do not preserve the header) */
};
