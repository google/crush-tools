...
static int run_in_parallel ( char *code, struct cmdargs *args, int argc, char *argv[], int optind ) ;
...
static int run_in_parallel ( char *script, struct cmdargs *args, int argc, char *argv[], int optind ) {
